...
$upload_dir = 'media/ves_layerslider/upload/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../media/ves_layerslider/upload/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../media/resized/'; // relative path from filemanager folder to thumbs folder (with final /)
