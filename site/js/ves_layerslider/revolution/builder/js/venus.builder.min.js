...
jQuery(function ($) {
        ...
        $(".sortable").sortable({
            ...
            afterShow: function (e) {
                ...
                if(typeof(getEditingElement().data("itemData")) != "undefined") {
                    var customclase = getEditingElement().data("itemData").customclase;
                }
                if(typeof(customclase) == "undefined" || customclase == "") {
                ...
                if(typeof(getEditingElement().data("customclase")) !="undefined" && getEditingElement().data("customclase")!= "") {
    ...
    var sliderSize = {
        ...
        height: 450
            ...
            customclase: function (e) {
                var t = getEditingElement(),
                    i = getEditingElement().data("itemData");
                if(e != "" && typeof(i) !="undefined" && typeof(t) != "undefined") {
                    i.customclase = e;
    ...
    $.fn.duplicate = function () {
        ...
        function i(e) {
           ...
           if(typeof(i.data("customclase")) !="undefined" && i.data("customclase") !="") {
    ...
    var easingList = ["linear", "swing", "jswing", "easeInQuad", "easeOutQuad", "easeInOutQuad", "easeInCubic", "easeOutCubic", "easeInOutCubic", "easeInQuart", "easeOutQuart", "easeInOutQuart", "easeInQuint", "easeOutQuint", "easeInOutQuint", "easeInSine", "easeOutSine", "easeInOutSine", "easeInExpo", "easeOutExpo", "easeInOutExpo", "easeInCirc", "easeOutCirc", "easeInOutCirc", "easeInElastic", "easeOutElastic", "easeInOutElastic", "easeInBack", "easeOutBack", "easeInOutBack", "easeInBounce", "easeOutBounce", "easeInOutBounce", "Linear.easeNone","Power0.easeIn","Power0.easeInOut","Power0.easeOut","Power1.easeIn","Power1.easeInOut","Power1.easeOut","Power2.easeIn","Power2.easeInOut", "Power2.easeOut","Power3.easeIn", "Power3.easeInOut","Power3.easeOut", "Power4.easeIn", "Power4.easeInOut", "Power4.easeOut", "Back.easeIn", "Back.easeInOut", "Back.easeOut", "Bounce.easeIn", "Bounce.easeInOut", "Bounce.easeOut", "Circ.easeIn", "Circ.easeInOut", "Circ.easeOut", "Elastic.easeIn", "Elastic.easeInOut", "Elastic.easeOut", "Expo.easeIn", "Expo.easeInOut", "Expo.easeOut", "Sine.easeIn", "Sine.easeInOut", "Sine.easeOut", "SlowMo.ease"],
        ...
        effectList = ["auto", "fadeout", "stt", "stb", "stl", "str", "ltt", "ltb", "ltl", "ltr", "customout", "randomrotateout"], 
        effectLabelList = {"auto": "Choose Automatic", 
                            "fadeout": "Fade Out", 
                            "stt": "Short to Top", 
                            "stb" : "Short to Bottom", 
                            "stl" : "Short to Left", 
