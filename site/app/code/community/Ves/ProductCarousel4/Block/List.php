...
class Ves_ProductCarousel4_Block_List extends Mage_Catalog_Block_Product_Abstract 
{
	/**
	 * @var string $_config
	 * 
	...
	public function __construct($attributes = array())
	{
		...
		$helper =  Mage::helper('ves_productcarousel4/data');
		...
		if(empty($my_template)) {
			$template = 'ves/productcarousel4/default.phtml';
	 ...
	 * @return string
	 */
	function getConfig( $key, $panel='ves_productcarousel4' ){
		if(isset($this->_config[$key])) {
			return $this->_config[$key];
		} else {
			return Mage::getStoreConfig("ves_productcarousel4/$panel/$key");
		}
	}
