<?php
class Ves_ProductCarousel4_Model_System_Config_Source_ListTheme
{
    ...
    public function toOptionArray()
    {
		...
		$directory = Mage::getBaseDir('design') . DS . 'frontend' . DS . 'default' . DS . 'default' .  DS . 'template'.  DS . 'ves'. DS .'productcarousel4';
