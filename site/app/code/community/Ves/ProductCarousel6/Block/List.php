...
class Ves_ProductCarousel6_Block_List extends Mage_Catalog_Block_Product_Abstract 
{
	/**
	 * @var string $_config
	 * 
	...
	public function __construct($attributes = array())
	{
		...
		if(empty($my_template)) {
			$template = 'ves/productcarousel6/default.phtml';
	 ...
	 * @return string
	 */
	function getConfig( $key, $panel='ves_productcarousel6' ){
		if(isset($this->_config[$key])) {
			return $this->_config[$key];
		} else {
			return Mage::getStoreConfig("ves_productcarousel6/$panel/$key");
		}
	}
