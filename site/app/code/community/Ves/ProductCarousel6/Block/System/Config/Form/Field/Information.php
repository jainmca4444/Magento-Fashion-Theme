...
class Ves_ProductCarousel6_Block_System_Config_Form_Field_Information  extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $useContainerId = $element->getData('use_container_id');
        return sprintf('<tr class="system-fieldset-sub-head" id="row_%s"><td colspan="6" class="ves-description">
					   <h3>	<a href="http://www.venustheme.com"><b>Magento - Venus Product Carousel6 Block</b></a>  </h3>
								The most elegant way to show list products of your magento store inside the smooth ProductCarousel6. 
							...
							<div>
								...
								<ul>
									<li>&lt block type="venustheme_productcarousel6/list" name="productcarousel6" /&gt</li>
									<li>{{block type="venustheme_productcarousel6/list" name="productcarousel6"}}</li>
								</ul>
