...
class Ves_ProductCarousel5_Block_System_Config_Form_Field_Information  extends Mage_Adminhtml_Block_Abstract implements Varien_Data_Form_Element_Renderer_Interface
{
	public function render(Varien_Data_Form_Element_Abstract $element)
    {
        $useContainerId = $element->getData('use_container_id');
        return sprintf('<tr class="system-fieldset-sub-head" id="row_%s"><td colspan="5" class="ves-description">
					   <h3>	<a href="http://www.venustheme.com"><b>Magento - Venus Product Carousel5 Block</b></a>  </h3>
								The most elegant way to show list products of your magento store inside the smooth ProductCarousel5. 
							...
							<div>
								...
								<ul>
									<li>&lt block type="venustheme_productcarousel5/list" name="productcarousel5" /&gt</li>
									<li>{{block type="venustheme_productcarousel5/list" name="productcarousel5"}}</li>
								</ul>
