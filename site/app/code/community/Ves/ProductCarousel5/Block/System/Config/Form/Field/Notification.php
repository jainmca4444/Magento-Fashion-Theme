...
class Ves_ProductCarousel5_Block_System_Config_Form_Field_Notification extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		...
		//$csspath = $url.'ves_productcarousel5/form/style.css';
