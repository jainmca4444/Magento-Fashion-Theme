...
class Ves_ProductCarousel5_Block_List extends Mage_Catalog_Block_Product_Abstract 
{
	/**
	 * @var string $_config
	 * 
	...
	public function __construct($attributes = array())
	{
		...
		if(empty($my_template)) {
			$template = 'ves/productcarousel5/default.phtml';
	 ...
	 * @return string
	 */
	function getConfig( $key, $panel='ves_productcarousel5' ){
		if(isset($this->_config[$key])) {
			return $this->_config[$key];
		} else {
			return Mage::getStoreConfig("ves_productcarousel5/$panel/$key");
		}
	}
